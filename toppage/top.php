...
$sql = "SELECT workspaces_id, name, created_at FROM workspaces ORDER BY $orderBy";
$stmt = $pdo->query($sql);
            ...
            <?php foreach ($workspaces as $ws): ?>
                <li class="workspace-card">
                    ...
                    <div class="workspace-actions">
                        ...
                        <?php if ($is_admin): ?>
                            <a class="edit-btn" href="#" data-id="<?= $ws['workspaces_id'] ?>" data-name="<?= htmlspecialchars($ws['name']) ?>">編集</a>
